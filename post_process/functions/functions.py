...
def garcia_angular_flux_sol(s):
    ...
    if (s==np.inf):
        sol = np.array((8.97797e-01, 8.87836e-01, 8.69581e-01, 8.52299e-01, 
                               8.35503e-01, 8.18996e-01, 8.02676e-01, 7.86493e-01, 
                               7.70429e-01, 7.54496e-01, 7.38721e-01,1.02202e-01, 
                               1.12164e-01, 1.30419e-01, 1.47701e-01, 
                                 1.64497e-01, 1.81004e-01, 1.97324e-01, 2.13507e-01, 
                                 2.29571e-01, 2.45504e-01, 2.61279e-01))
    elif (s==1):
        sol = np.array((0.58966, 0.53112, 0.44328, 0.38031, 0.33296, 0.29609,
                        0.26656, 0.24239, 0.22223, 0.20517, 0.19055, 0.6075e-5,
                        0.69252e-5, 0.96423e-5, 0.16234e-6, 0.43858e-4,
                        0.16937e-3, 0.57347e-3, 0.15128e-2, 0.32437e-2,
                        0.59604e-2, 0.97712e-2))
    return sol #(sol_left, sol_right)
...
def SN_Sweep(angles, qmc_data):
    ...
    temp = psi[:Na,0]
    temp = np.append(temp, psi[Na:Na2,-1])
